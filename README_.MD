...
git add .
git commit -m " Η εφαρμογή calendar είναι έτοιμη για χρήση! Το μόνο που απομένει
  είναι η επίλυση του frontend permission issue για να
  τεσταριστεί πλήρως η ολοκληρωμένη λειτουργικότητα."
git branch -M main 
