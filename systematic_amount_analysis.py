...
class SystematicAmountAnalyzer:
    ...
    def analyze_amount_216_67(self):
        ...
        print(f"  📊 Υπολογισμός από πυλώνες:")
        ...
        print(f"  🎯 Σκοπός ποσού 216,67€:")
        print(f"     • Μηνιαίες υποχρεώσεις κτιρίου")
        print(f"     • Σύνολο δαπανών + διαχείρισης + αποθεματικού")
        print(f"     • Ποσό που πρέπει να συλλεχθεί από κατοίκους")
        
        print_subsection("4. ΑΥΘΕΝΤΙΚΟΤΗΤΑ")
        
        if abs(calculated_total - amount) < Decimal('0.01'):
            print(f"  ✅ ΑΥΘΕΝΤΙΚΟ: Το ποσό είναι σωστό")
            print(f"     📍 Υπολογίζεται από πυλώνες δεδομένων")
            print(f"     🔍 Επαληθεύσιμο από λογαριασμούς")
        else:
            print(f"  ⚠️  ΠΡΟΒΛΗΜΑ: Διαφορά {format_currency(abs(calculated_total - amount))}")
            print(f"     📍 Χρειάζεται διερεύνηση")
        
        print_subsection("5. ΕΠΑΝΑΧΡΗΣΙΜΟΠΟΙΗΣΗ")
        
        # Εύρεση όλων των τοποθεσιών
        print(f"  🔄 Τοποθεσίες όπου εμφανίζεται 216,67€:")
        ...
        print(f"  📝 Ορολογίες που χρησιμοποιούνται:")
        print(f"     • 'Μηνιαίες υποχρεώσεις'")
        print(f"     • 'Αρνητικό Υπόλοιπο'")
        print(f"     • 'Τι πρέπει να πληρωθεί αυτόν τον μήνα'")
        print(f"     ⚠️  ΠΡΟΒΛΗΜΑ: Διαφορετικές ορολογίες για ίδιο ποσό")
    ...
    def analyze_amount_955_84(self):
        ...
        print(f"  🎯 Σκοπός ποσού 955,84€:")
        print(f"     • Τρέχον ταμείο κτιρίου")
        print(f"     • Διαθέσιμο ποσό από εισπράξεις μείον δαπάνες")
        print(f"     • Ποσό διαθέσιμο για μελλοντικές δαπάνες")
        ...
        if abs(calculated_reserve - amount) < Decimal('0.01'):
            print(f"  ✅ ΑΥΘΕΝΤΙΚΟ: Το ποσό είναι σωστό")
            print(f"     📍 Υπολογίζεται από πυλώνες δεδομένων")
            print(f"     🔍 Επαληθεύσιμο από συναλλαγές")
        else:
        ...
        # Εύρεση όλων των τοποθεσιών
        print(f"  🔄 Τοποθεσίες όπου εμφανίζεται 955,84€:")
        for location in locations:
            print(f"     📍 {location['source']}")
            print(f"        📊 {location['field']}: {location['value']}")
            print(f"        💬 {location['description']}")
        ...
        print(f"  📝 Ορολογίες που χρησιμοποιούνται:")
        print(f"     • 'Τρέχον ταμείο'")
        print(f"     • 'Διαθέσιμο ποσό από εισπράξεις μείον δαπάνες'")
        print(f"     • 'Συνολικό υπόλοιπο'")
        print(f"     ✅ ΚΑΛΟ: Συνεπείς ορολογίες")
    ...
    def analyze_conflict(self):
        ...
        print(f"  ⚠️  ΣΥΓΚΡΟΥΣΗ ΕΝΤΟΠΙΣΘΗΚΕ:")
        print(f"     • Αρνητικό Υπόλοιπο: 216,67€")
        print(f"     • Τρέχον Ταμείο: 955,84€")
        print(f"     • ΠΡΟΒΛΗΜΑ: Πώς μπορεί να υπάρχει αρνητικό υπόλοιπο")
        print(f"       και ταυτόχρονα διαθέσιμο ταμείο;")
        ...
        print(f"     • Τρέχον ταμείο: 955,84€")
        print(f"     • Μηνιαίες υποχρεώσεις: 216,67€")
        print(f"     • Διαφορά: {format_currency(difference)}")
        
        print_subsection("3. ΕΡΜΗΝΕΙΑ")
        
        print(f"  💡 ΠΙΘΑΝΕΣ ΕΡΜΗΝΕΙΕΣ:")
        print(f"     • Το κτίριο έχει διαθέσιμο ταμείο 955,84€")
        print(f"     • Αλλά χρειάζεται να πληρώσει 216,67€ αυτόν τον μήνα")
        print(f"     • Επομένως το υπόλοιπο θα γίνει: {format_currency(difference)}")
        print(f"     • ΔΕΝ είναι αρνητικό υπόλοιπο!")
        
        print_subsection("4. ΠΡΟΒΛΗΜΑ ΟΡΟΛΟΓΙΑΣ")
        
        print(f"  🔍 ΠΡΟΒΛΗΜΑ: Λάθος ορολογία")
        print(f"     • 'Αρνητικό Υπόλοιπο' είναι ΛΑΘΟΣ")
        print(f"     • Πρέπει να είναι 'Μηνιαίες Υποχρεώσεις'")
        print(f"     • Το κτίριο ΔΕΝ έχει αρνητικό υπόλοιπο")
    ...
    def generate_recommendations(self):
        ...
        print(f"  📝 ΑΛΛΑΓΕΣ ΠΡΕΠΕΙ ΝΑ ΓΙΝΟΥΝ:")
        print(f"     • 'Αρνητικό Υπόλοιπο' → 'Μηνιαίες Υποχρεώσεις'")
        print(f"     • 'Χρειάζεται να πληρωθούν οι τρέχουσες υποχρεώσεις πρώτα'")
        print(f"       → 'Μηνιαίες υποχρεώσεις για τον τρέχοντα μήνα'")
        print(f"     • 'Το κτίριο έχει αρνητικό υπόλοιπο'")
        print(f"       → 'Το κτίριο έχει θετικό υπόλοιπο {format_currency(Decimal("739.17"))}'")
        
        print_subsection("2. ΒΕΛΤΙΩΣΗ ΚΑΤΑΝΟΗΤΟΤΗΤΑΣ")
        
        print(f"  💡 ΠΡΟΤΑΣΕΙΣ ΒΕΛΤΙΩΣΗΣ:")
        print(f"     • Προσθήκη επεξηγηματικών σημειώσεων")
        print(f"     • Διαχωρισμός 'Μηνιαίες Υποχρεώσεις' από 'Τρέχον Υπόλοιπο'")
        print(f"     • Χρήση χρωμάτων για διαφορετικές κατηγορίες")
        print(f"     • Προσθήκη tooltips με επεξηγήσεις")
        
        print_subsection("3. ΕΠΑΛΗΘΕΥΣΗ")
        
        print(f"  ✅ ΕΠΑΛΗΘΕΥΣΗ:")
        print(f"     • Όλα τα ποσά είναι σωστά")
        print(f"     • Το πρόβλημα είναι μόνο στην ορολογία")
        print(f"     • Η λογική είναι σωστή")
        print(f"     • Χρειάζεται μόνο διόρθωση ορολογίας")
...
def main():
    ...
    with schema_context('demo'):
        analyzer = SystematicAmountAnalyzer(building_id=1)  # Αραχώβης 12
