  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Μηνιαία Υπόλοιπα</h2>
          <p className="text-muted-foreground">
            Διαχείριση και κλείσιμο μηνιαίων υπολοίπων με μεταφορά οφειλών
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-6">
                    ...
                    {/* Carry Forward - Always show for debugging */}
                    <div className="text-center">
                      <div className={`flex items-center justify-center space-x-1 ${Number(balance.carry_forward) < 0 ? 'text-red-600' : 'text-green-600'}`}>
                        <TrendingDown className="w-4 h-4" />
                        <span className="text-lg font-bold">
                          {formatCurrency(Math.abs(Number(balance.carry_forward)))}
                        </span>
                      </div>
                      <p className="text-xs text-gray-500">Μεταφορά</p>
                      <div className="text-xs text-gray-400">
                        Debug: {balance.carry_forward} (type: {typeof balance.carry_forward})
                      </div>
                    </div>
