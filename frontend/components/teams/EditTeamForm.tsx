...
export default function EditTeamForm({ team, onTeamUpdated }: EditTeamFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await api.put(`/teams/teams/${team.id}/`, {
        ...formData,
      ...
      alert('Σφάλμα κατά την ενημέρωση ομάδας');
    } finally {
      setLoading(false);
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Ενημερώστε τα στοιχεία της ομάδας.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button type="submit" disabled={loading}>
              {loading ? 'Ενημέρωση...' : 'Ενημέρωση Ομάδας'}
            </Button>
          </div>
        </form>
      </DialogContent>
