  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const payload: CreateAnnouncementPayload = {
        ...
        end_date: assemblyDate, // Same day as start
        file: undefined,
        is_active: true,
      ...
      toast.error((err as Error).message || 'Αποτυχία δημιουργίας ανακοίνωσης συνέλευσης');
    } finally {
      setSubmitting(false);
    }
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="assemblyTitle" className="block text-sm font-medium text-blue-800">
          ...
          <div>
            <label htmlFor="assemblyDate" className="block text-sm font-medium text-blue-800">
          ...
          <div>
            <label htmlFor="assemblyTime" className="block text-sm font-medium text-blue-800">
              Ώρα Συνέλευσης *
            </label>
            <Input
              id="assemblyTime"
          ...
          {!isOnline && (
            <div className="md:col-span-2">
              <label htmlFor="assemblyLocation" className="block text-sm font-medium text-blue-800">
          ...
          {isOnline && (
            <div className="md:col-span-2">
              <label htmlFor="meetingLink" className="block text-sm font-medium text-blue-800">
