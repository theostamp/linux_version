...
export const CalculatorModal: React.FC<CalculatorModalProps> = ({ children }) => {
  ...
  const formatDisplay = (value: string) => {
    ...
    // Αν είναι ακέραιος, εμφάνιση χωρίς δεκαδικά
    if (Number.isInteger(num)) {
      return num.toString();
    }
    
    // Αν έχει δεκαδικά, εμφάνιση με 2 δεκαδικά ψηφία
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 pt-2 border-t">
            <Button
              ...
              size="sm"
              onClick={() => {
                const result = parseFloat(display) * 1.24; // 24% ΦΠΑ
            ...
            <Button
              ...
              size="sm"
              onClick={() => {
                const result = parseFloat(display) / 1.24; // Χωρίς ΦΠΑ
                setDisplay(String(result));
              }}
              className="flex-1 text-xs"
            >
            ...
            <Button
              ...
              size="sm"
              onClick={() => {
                const result = parseFloat(display) * 0.1; // 10%
                setDisplay(String(result));
              }}
              className="flex-1 text-xs"
            >
