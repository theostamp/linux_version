...
def create_july_2025_expenses():
    ...
    with schema_context('demo'):
        ...
        print(f"🏠 Ίσα μερίδια (μόνο διαχείριση): {equal_share_total}€ → {equal_share_per_apartment}€/διαμέρισμα")
        print(f"📊 Κατά χιλιοστά (όλα τα υπόλοιπα): {mills_share_total}€ → {mills_share_per_apartment}€/διαμέρισμα")
