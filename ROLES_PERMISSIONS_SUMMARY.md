...
#### 4. **Αιτήματα Συντήρησης (Maintenance Requests)**
- ✅ **Δημιουργία**: Μπορεί να δημιουργεί αιτήματα συντήρησης (Maintenance Tickets)
- ✅ **Προβολή**: Μπορεί να βλέπει αιτήματα συντήρησης (μόνο για τη δική του πολυκατοικία)
- ❌ **Επεξεργασία/Διαγραφή**: Δεν μπορεί να επεξεργάζεται ή να διαγράφει αιτήματα (μόνο Office Managers)
...
| **Αιτήματα Συντήρησης** | ✅ Δημιουργία/Προβολή | ✅ Δημιουργία/Προβολή |
