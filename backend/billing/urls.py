...
urlpatterns = [
    ...
    # Stripe Billing Portal (payment method management)
    path('portal/', BillingPortalSessionView.as_view(), name='billing-portal'),
    path('portal', BillingPortalSessionView.as_view(), name='billing-portal-no-slash'),
