...
# 📁 Paths & Base
# ----------------------------------------
# BASE_DIR is now one level deeper (settings/base.py instead of settings.py)
...
# CSRF Trusted Origins - configured in dev.py and prod.py
# Base settings don't set CSRF_TRUSTED_ORIGINS (handled by environment-specific files)
CSRF_TRUSTED_ORIGINS = []

# Railway domains - moved to prod.py (no hardcoded domains in base)

IS_PRODUCTION = os.getenv("ENV", "development") == "production"

# Railway proxy settings - moved to prod.py
# Base settings don't override ALLOWED_HOSTS with wildcard
...
EMAIL_BACKEND = os.getenv('EMAIL_BACKEND', 'users.mailersend_backend.MailerSendEmailBackend')
