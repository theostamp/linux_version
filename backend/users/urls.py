...
from . import views
from .views import login_view, CustomTokenObtainPairView, PublicSchemaTokenRefreshView, me_view
...
urlpatterns = [
    ...
    path('resend-verification/', views.resend_verification_view, name='user-resend-verification'),  # Resend verification with slash
    path('resend-verification', views.resend_verification_view, name='user-resend-verification-no-slash'),  # Resend verification without slash
    ...
    path('check-username/', views.check_username_availability, name='user-check-username'),  # Check username availability with slash
    path('check-username', views.check_username_availability, name='user-check-username-no-slash'),  # Check username availability without slash
    ...
    path('token/refresh/', PublicSchemaTokenRefreshView.as_view(), name='token_refresh'),  # Token refresh endpoint (public schema)
    path('token/refresh', PublicSchemaTokenRefreshView.as_view(), name='token_refresh-no-slash'),  # Token refresh without slash
