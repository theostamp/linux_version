...
urlpatterns = [
    ...
    path('send-myapartment-link/', views.send_myapartment_link_view, name='user-send-myapartment-link'),
    path('send-myapartment-link', views.send_myapartment_link_view, name='user-send-myapartment-link-no-slash'),
    path('request-magic-link/', views.request_magic_link_view, name='user-request-magic-link'),
    path('request-magic-link', views.request_magic_link_view, name='user-request-magic-link-no-slash'),
