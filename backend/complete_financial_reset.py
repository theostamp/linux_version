...
def complete_financial_reset():
    """
    Πλήρης μηδενικοποίηση όλων των οικονομικών δεδομένων στη βάση δεδομένων
    """
    print("🚀 Ξεκινάω την πλήρη μηδενικοποίηση όλων των οικονομικών δεδομένων...")
    ...
    with schema_context('demo'):
        try:
            with transaction.atomic():
                ...
                # 2. Διαγράφω όλες τις συναλλαγές ΠΡΩΤΑ (για να αποφύγω τα signals)
                ...
                print("\n🎉 Όλα τα οικονομικά δεδομένα διαγράφηκαν πλήρως!")
                print("📊 Η βάση δεδομένων είναι τώρα εντελώς καθαρή")
