    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_building_mills', models.PositiveIntegerField(default=1000, verbose_name='Συνολικά Μιλέσιμα Κτιρίου')),
                ...
                ('achieved_quorum_mills', models.PositiveIntegerField(default=0, verbose_name='Επιτευχθέντα Μιλέσιμα')),
