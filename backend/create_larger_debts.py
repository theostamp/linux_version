...
# -*- coding: utf-8 -*-
"""
Δημιουργία μεγαλύτερων οφειλών για δοκιμή της πλήρους λειτουργικότητας
"""
...
def create_larger_debts():
    """Δημιουργία μεγαλύτερων οφειλών"""
    
    with schema_context('demo'):
        print("💰 ΔΗΜΙΟΥΡΓΙΑ ΜΕΓΑΛΥΤΕΡΩΝ ΟΦΕΙΛΩΝ")
        print("=" * 50)
        ...
        # Δημιουργία μεγάλων οφειλών για τα διαμερίσματα 1, 3, 5, 7, 9
        debts_data = [
            {'apartment_number': '1', 'debt_amount': Decimal('500.00')},
            {'apartment_number': '3', 'debt_amount': Decimal('350.00')},
            {'apartment_number': '5', 'debt_amount': Decimal('450.00')},
            {'apartment_number': '7', 'debt_amount': Decimal('300.00')},
            {'apartment_number': '9', 'debt_amount': Decimal('400.00')}
        ]
        ...
        for debt_data in debts_data:
            ...
            if apartment:
                ...
                transaction = Transaction.objects.create(
                    ...
                    description=f"Μεγάλη οφειλή προηγούμενων μηνών - {debt_data['apartment_number']}",
                ...
                print(f"💰 Δημιουργήθηκε μεγάλη οφειλή: Διαμέρισμα {apartment.number} - {debt_data['debt_amount']}€")
        ...
        print("✅ ΟΛΟΚΛΗΡΩΘΗΚΕ Η ΔΗΜΙΟΥΡΓΙΑ ΜΕΓΑΛΥΤΕΡΩΝ ΟΦΕΙΛΩΝ")
