#!/usr/bin/env python3
"""
Debug script για να δούμε τι συμβαίνει στη μέθοδο _calculate_reserve_fund_contribution
"""
...
def debug_reserve_fund_contribution():
    """Debug reserve fund contribution"""
    
    with schema_context('demo'):
        print("🔍 DEBUG: Reserve Fund Contribution")
        print("=" * 50)
...
if __name__ == "__main__":
    debug_reserve_fund_contribution()
