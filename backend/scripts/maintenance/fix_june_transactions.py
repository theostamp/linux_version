#!/usr/bin/env python3
"""
Script για δημιουργία συναλλαγών του Ιουνίου
"""
...
def fix_june_transactions():
    """Δημιουργεί συναλλαγές για τις δαπάνες του Ιουνίου"""
    
    with schema_context('demo'):
        print("🔧 ΔΗΜΙΟΥΡΓΙΑ ΣΥΝΑΛΛΑΓΩΝ ΙΟΥΝΙΟΥ 2025")
        print("=" * 60)
        ...
        if existing_transactions.count() > 0:
            print(f"⚠️ ΥΠΑΡΧΟΥΝ ΗΔΗ {existing_transactions.count()} ΣΥΝΑΛΛΑΓΕΣ ΑΠΟ ΤΟΝ ΙΟΥΝΙΟ!")
