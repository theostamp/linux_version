#!/usr/bin/env python3
"""
Test script to verify that the modal shows the correct data for the Alkmanos building
"""
...
def test_alkmanos_modal():
    """Test that the modal shows the correct data for the Alkmanos building"""
    
    with schema_context('demo'):
        # Get the Alkmanos building
        building = Building.objects.get(id=4)  # Αλκμάνος 22, Αθήνα 115 28
        
        print(f"🏢 Testing Alkmanos building: {building.name}")
