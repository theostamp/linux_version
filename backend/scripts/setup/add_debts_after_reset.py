...
# -*- coding: utf-8 -*-
"""
Προσθήκη οφειλών μετά το μηδενισμό των υπολοίπων
"""
...
def add_debts_after_reset():
    """Προσθήκη οφειλών μετά το μηδενισμό"""
    
    with schema_context('demo'):
        print("💰 ΠΡΟΣΘΗΚΗ ΟΦΕΙΛΩΝ ΜΕΤΑ ΤΟ ΜΗΔΕΝΙΣΜΟ")
        print("=" * 50)
