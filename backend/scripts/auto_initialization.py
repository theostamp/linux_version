...
- Αλκμάνος 22 (10 διαμερίσματα) - Αληθοφανή δεδομένα ενοίκων

📊 DEMO ΔΕΔΟΜΕΝΑ:
-----------------
- 2 κτίρια
- 4 χρήστες
- 20 διαμερίσματα συνολικά
...
- A2: Ελένη Δημητρίου (ιδιοκτήτης)
- A3: Νίκος Αλεξίου → Αννα Παπαδοπούλου (ενοικιαστής)

Όροφος 2:
- B1: Δημήτρης Κωνσταντίνου (ιδιοκτήτης)
- B2: Κατερίνα Γεωργίου → Παύλος Μιχαηλίδης (ενοικιαστής)
- B3: Ανδρέας Παπαδάκης (ιδιοκτήτης)

Όροφος 3:
- C1: Σοφία Νικολάου → Γιώργος Δημητρίου (ενοικιαστής)
- C2: Μιχάλης Αντωνίου (ιδιοκτήτης)
- C3: Ευαγγελία Παπαδοπούλου → Δημήτρης Κωνσταντίνου (ενοικιαστής)
...
def main():
    ...
    print("\n🏢 Κτίριο: Αραχώβης 12 (10 διαμερίσματα)")
    print("   Διεύθυνση: Αραχώβης 12, Αθήνα 106 80, Ελλάδα")
    print("   Πλήρη λειτουργικά δεδομένα με μηδενικά οικονομικά στοιχεία")
    print("\n🏢 Κτίριο: Αλκμάνος 22 (10 διαμερίσματα)")
    print("   Διεύθυνση: Αλκμάνος 22, Αθήνα 115 28, Ελλάδα")
    print("   Αληθοφανή δεδομένα ενοίκων και χιλιοστών με μηδενικά οικονομικά στοιχεία")
