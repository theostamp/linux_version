    ...
    with schema_context('demo'):
        ...
        for building in buildings:
            ...
            if not building.reserve_contribution_per_apartment:
                print("   ⚠️  Δεν έχει οριστεί εισφορά αποθεματικού ανά διαμέρισμα")
                building_issues += 1
            
            if not building.management_fee_per_apartment:
                print("   ⚠️  Δεν έχει οριστεί διαχειριστικά τέλη ανά διαμέρισμα")
                building_issues += 1
            ...
            if apartments.count() == 0:
                print("   ❌ Δεν υπάρχουν διαμερίσματα")
                building_issues += 1
            ...
            if building.current_reserve and building.current_reserve < 0:
                print("   ⚠️  Το αποθεματικό είναι αρνητικό")
                building_issues += 1
            ...
            try:
                ...
                if summary.get('reserve_fund_contribution', 0) < 0:
                    print("   ❌ Αρνητική εισφορά αποθεματικού")
                    building_issues += 1
            ...
            if apartments_with_negative_balance.exists():
                print("   ⚠️  Λίστα διαμερισμάτων με αρνητικό υπόλοιπο:")
            ...
            if building_issues == 0:
                print("   ✅ Το κτίριο είναι σε καλή κατάσταση")
            else:
        ...
        if total_issues > 0:
            print("   1. 🔧 Διόρθωση ρυθμίσεων αποθεματικού")
            print("   2. 🔧 Διόρθωση participation mills")
            print("   3. 🔧 Εξόφληση εκκρεμών πληρωμών")
            print("   4. 🔧 Έλεγχος αρνητικών αποθεματικών")
        else:
            print("   1. ✅ Το σύστημα λειτουργεί σωστά")
            print("   2. ✅ Όλα τα δεδομένα είναι αξιόπιστα")
            print("   3. ✅ Δεν χρειάζονται διορθώσεις")
