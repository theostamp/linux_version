    ...
    with tenant_context(client):
        ...
        for building in buildings:
            ...
            if building.management_office_name:
                ...
                print(f"   ⚠️  Δεν έχει οριστεί γραφείο διαχείρισης")
            ...
            if management_fee == 0:
                print(f"      ✅ Σενάριο 1: Μηδενική αμοιβή διαχείρισης")
            else:
                print(f"      ✅ Σενάριο 1: Υπάρχει αμοιβή διαχείρισης")
            
            # Scenario 2: No apartments
            if apartments_count == 0:
                print(f"      ⚠️  Σενάριο 2: Δεν υπάρχουν διαμερίσματα")
            else:
                print(f"      ✅ Σενάριο 2: Υπάρχουν {apartments_count} διαμερίσματα")
            
            # Scenario 3: Management office info
            if building.management_office_name:
                print(f"      ✅ Σενάριο 3: Υπάρχουν πληροφορίες γραφείου")
            else:
                print(f"      ⚠️  Σενάριο 3: Δεν υπάρχουν πληροφορίες γραφείου")
