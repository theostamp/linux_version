...
def test_complete_expense_deletion_fix():
    ...
    with schema_context('demo'):
        ...
        if integrity_check['balance_details']:
            print("   📋 Λεπτομέρειες ασυνεπών υπολοίπων:")
        ...
        if final_integrity_check['orphaned_transactions'] == 0 and final_integrity_check['inconsistent_balances'] == 0:
            print("   ✅ Όλα τα δεδομένα είναι καθαρά και συνεπή!")
            print("   ✅ Η διόρθωση λειτούργησε επιτυχώς!")
        else:
            print("   ⚠️ Υπάρχουν ακόμα προβλήματα ακεραιότητας")
        
        if total_negative_balance == Decimal('0.00'):
            print("   ✅ Δεν υπάρχουν αρνητικές οφειλές!")
        else:
