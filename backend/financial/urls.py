...
from .views import (
    ExpenseViewSet, ExpensePaymentViewSet, CashFundingViewSet, TransactionViewSet, PaymentViewSet,
...
router.register(r'cash-fundings', CashFundingViewSet, basename='cash-fundings')
