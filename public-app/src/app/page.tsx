...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Δεν χρειάζεται να συλλέγεις χειροκίνητα δαπάνες, να εκτυπώνεις και να κάνεις διανομή πόρτα-πόρτα. Τα παραστατικά περνάνε αυτόματα, τα κοινόχρηστα οργανώνονται κεντρικά και οι ένοικοι ενημερώνονται ψηφιακά ή από το Info Point.",
  },
];
...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "ΑΣ",
    rating: 5,
    text: "Η μηνιαία έκδοση κοινοχρήστων ήταν μαραθώνιος με χαρτιά και διανομές. Με την αυτόματη καταχώρηση περνάμε τα παραστατικά σε λεπτά και οι ένοικοι ενημερώνονται από το Info Point. Κερδίζουμε χρόνο κάθε μήνα.",
  },
];
            ...
            <div className="w-full space-y-8 rounded-3xl bg-[var(--bg-dark-card)] p-6 shadow-2xl shadow-card-soft backdrop-blur-md sm:p-8 lg:p-10">
              <AnimatedSection delay={100}>
                <div className="flex justify-start">
                  <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-4 py-1.5 text-xs font-medium uppercase tracking-wide text-on-dark">
                    ...
                    Για γραφεία & διαχειριστές • Οργάνωση & ζωντανή ενημέρωση
                  </span>
                </div>
              </AnimatedSection>
              <AnimatedSection delay={125}>
                <p className="text-center text-base font-semibold text-lime-300 sm:text-lg">
              ...
              <AnimatedSection delay={200}>
                <p className="text-left text-base leading-relaxed text-on-dark-secondary sm:text-lg md:text-xl lg:text-2xl">
                  Σήμερα ένα γραφείο ή ένας μεμονωμένος διαχειριστής χάνει ώρες σε παραστατικά, κοινόχρηστα και απορίες.
                  Το newconcierge.app τα οργανώνει αυτόματα και ενημερώνει άμεσα όλους, ενώ το Info Point ολοκληρώνει το πακέτο
                  αναβαθμίζοντας την εικόνα της πολυκατοικίας και του γραφείου.
                </p>
              </AnimatedSection>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                description:
                  "Ο διαχειριστής δουλεύει από ένα καθαρό dashboard και περνάει παραστατικά αυτόματα σε λίγα δευτερόλεπτα. Κοινόχρηστα, ανακοινώσεις και αποφάσεις ενημερώνονται αυτόματα.",
      ...
      <section id="features" className="border-b border-gray-200 bg-gradient-to-b from-[var(--bg-dark-main)] via-[var(--bg-dark-surface)] to-[var(--bg-dark-main)]">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <AnimatedSection>
            <div className="mb-12 text-left">
              ...
              <h2 className="text-2xl font-bold text-on-dark-title sm:text-3xl lg:text-4xl">
                Εργαλεία που απλοποιούν την καθημερινή διαχείριση
              </h2>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Αυτόματη καταχώρηση παραστατικών",
                description:
                  "Ανεβάζεις τιμολόγια και παραστατικά και καταχωρούνται αυτόματα. Τέλος το χειροκίνητο πέρασμα.",
              },
              {
              ...
              <div className="rounded-xl border border-accent-primary/30 bg-[var(--bg-white)] p-4 shadow-card-soft">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    "Scenes & widgets",
                    "Αυτόματη καταχώρηση παραστατικών",
                    "Ηλεκτρονικό αρχείο",
                    "Όλα τα Web features"
                  ].map((f) => (
                    <li key={f} className="flex items-center gap-2 text-xs text-[var(--text-dark-secondary)] sm:text-sm">
      ...
      <section id="for-managers" className="border-b border-gray-200 bg-[var(--bg-main-light)]">
        <div className="mx-auto flex max-w-7xl flex-col gap-12 px-4 py-16 sm:px-6 md:flex-row md:items-center lg:px-8">
          <div className="flex-1 space-y-6">
            ...
            <AnimatedSection delay={100}>
              <h2 className="text-2xl font-bold text-accent-primary sm:text-3xl lg:text-4xl">
                Για γραφεία διαχείρισης: κερδίστε χρόνο, δουλέψτε πιο οργανωμένα
              </h2>
            </AnimatedSection>
            <AnimatedSection delay={200}>
              <p className="text-base leading-relaxed text-[var(--text-dark-secondary)] sm:text-lg">
                ...
                και κρατάει τα παραστατικά οργανωμένα και ενημερώνει ψηφιακά τους ενοίκους, ενώ το Info Point
