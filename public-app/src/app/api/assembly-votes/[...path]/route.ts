...
export function middleware(request: NextRequest) {
  console.log("[assembly-votes proxy:path] incoming", {
    ...
    resolvePath: async (_request, context) => {
      ...
      const pathSegments = Array.isArray(segments)
        ...
        : segments
          ? [segments]
          : [];
      return ["assembly-votes", ...pathSegments].join("/");
    },
...
const { GET, POST, PUT, PATCH, DELETE, OPTIONS } = exportHandlers(handlers, methods, "assembly-votes");
