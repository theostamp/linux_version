## TODO: Υπηρεσίες • Προσφορές & Έργα

Σκοπός: Ενοποίηση domains «Υπηρεσίες» και «Προσφορές & Έργα», χωρίς mocks/hardcoded δεδομένα, με πλήρη multi-tenancy, σύνδεση με την εφαρμογή TODOS (υπενθυμίσεις/ημερολόγιο), και realtime ενημερώσεις.
...
- Δέσιμο με «Υπηρεσίες» (Tickets/Work Orders) και προβολές στο Kiosk όπου χρειάζεται.
